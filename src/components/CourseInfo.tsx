...
const CourseInfo: FC<PropsWithChildren<CourseInfoProps>> = ({logo, messageDescription, messageTitle, children}) => {
  return (
    <div className="flex flex-col text-center gap-y-4 w-72">
      <img src={logo} alt="Clock" className="h-14 w-14 mx-auto" />
      {messageDescription && <h3 className="text-2xl font-light">{messageDescription}</h3>}
