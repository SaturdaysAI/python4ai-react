...
const Footer: FC = () => {
  ...
  return (
    <footer className="flex flex-col gap-y-12 py-16 px-10 bg-gunmetal mt-20">
      ...
      <div className="flex justify-center items-center text-center font-normal text-charcoal-light text-sm">
        <p>© 2018-2022 Saturdays AI . All Rights Reserved | </p>
        <NavLink inFooter={true} to="https://saturdays.ai/privacy-policy-2/">Privacy Policy</NavLink>
      </div>
